...
<body>
	...
	<h3>formatDate -> 날짜의 형식변환(반드시 날짜형식을 가지고 있어야 한다)</h3>
	...
	<fmt:parseDate var="day_a" value="${time_a}" pattern="yyyy-MM-dd" />
	<fmt:formatDate var="b" value="${day_a }" pattern="yyyy년MM월dd일" />
	${b }
